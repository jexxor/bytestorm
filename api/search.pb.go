...
func (x *LookupResponse) GetIndex() int32 {
	if x != nil {
		return x.Index
	}
	return 0
...
const file_search_proto_rawDesc = "" +
	...
	"\x05found\x18\x02 \x01(\bR\x05found2V\n" +
	"\rSearchService\x12E\n" +
	"\x06Lookup\x12\x1c.bytestorm.api.LookupRequest\x1a\x1d.bytestorm.api.LookupResponseB\x1aZ\x18jexxor/bytestorm/api;apib\x06proto3"
...
var file_search_proto_depIdxs = []int32{
	...
	1, // 1: bytestorm.api.SearchService.Lookup:output_type -> bytestorm.api.LookupResponse
